    ...
    <div className="min-h-screen pb-20 animate-fade-in" style={{ backgroundColor: 'transparent' }}>
      <div className="max-w-lg mx-auto px-4 pt-8">
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="mt-1.5 text-xs leading-relaxed whitespace-pre-line" style={{ color: '#8BA3C4' }}>
                        {prompt.template}
                      </p>
                    </div>
        ...
        {(!prompts || prompts.length === 0) && (
          <p className="text-sm text-center py-8" style={{ color: '#8BA3C4' }}>Prompts coming soon.</p>
        )}
      </div>
      <BottomNav />
    </div>
