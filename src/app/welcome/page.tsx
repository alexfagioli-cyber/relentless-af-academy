    ...
    <div className="min-h-screen px-4 py-12 sm:py-16" style={{ backgroundColor: 'transparent' }}>
      <div className="max-w-lg mx-auto">
        ...
        <div className="space-y-5 text-base leading-relaxed mb-10" style={{ color: '#D1D5DB' }}>
          <p>
            <span className="font-semibold" style={{ color: '#FFFFFF' }}>Alex invited you here for a reason.</span>
          </p>
          ...
          <div className="space-y-3">
            <div className="rounded-lg p-5" style={{ backgroundColor: '#25253D', borderLeft: '3px solid #E8C872' }}>
              <p className="text-sm leading-relaxed" style={{ color: '#D1D5DB' }}>
                <span className="font-semibold" style={{ color: '#FFFFFF' }}>Students</span> are using AI to revise smarter, break down complex topics in seconds, and write with more clarity than they ever thought possible.
              </p>
            </div>
            <div className="rounded-lg p-5" style={{ backgroundColor: '#25253D', borderLeft: '3px solid #E8C872' }}>
              <p className="text-sm leading-relaxed" style={{ color: '#D1D5DB' }}>
                <span className="font-semibold" style={{ color: '#FFFFFF' }}>Professionals</span> are automating half their admin, generating reports in minutes, and making better decisions with AI-powered analysis.
              </p>
            </div>
            <div className="rounded-lg p-5" style={{ backgroundColor: '#25253D', borderLeft: '3px solid #E8C872' }}>
              <p className="text-sm leading-relaxed" style={{ color: '#D1D5DB' }}>
                <span className="font-semibold" style={{ color: '#FFFFFF' }}>Builders</span> are creating apps, tools, and entire businesses that didn&apos;t exist six months ago — some without writing a single line of code.
              </p>
            </div>
          </div>
          <p className="mt-4 text-base font-semibold" style={{ color: '#FFFFFF' }}>
        ...
        <div className="mb-10 pt-8" style={{ borderTop: '1px solid #25253D' }}>
          <p className="text-sm leading-relaxed mb-4" style={{ color: '#D4D4E8' }}>
