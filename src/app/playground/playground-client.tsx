    ...
    <div className="flex flex-col h-[100dvh]" style={{ backgroundColor: '#1A1A2E' }}>
      ...
      <div className="px-4 pt-4 pb-3" style={{ borderBottom: '1px solid #363654' }}>
        <div className="flex items-center justify-between max-w-lg mx-auto">
          <div>
            <h1 className="text-lg font-bold" style={{ color: '#FFFFFF' }}>AI Playground</h1>
            <p className="text-xs" style={{ color: '#D4D4E8' }}>Practice your prompts</p>
          </div>
          <Link href="/" className="text-xs" style={{ color: '#D4D4E8' }}>
            ← Back
          </Link>
        </div>
      </div>
