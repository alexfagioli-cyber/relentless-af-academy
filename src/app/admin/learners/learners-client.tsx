            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-3 mt-0.5 text-xs" style={{ color: '#8BA3C4' }}>
                    <span>{l.email}</span>
                ...
                <span className="text-xs flex-shrink-0" style={{ color: '#8BA3C4' }}>
                  {isExpanded ? '\u25BC' : '\u25B6'}
                </span>
              </div>
            </button>
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                  ...
                  <div>
                    ...
                    <span style={{ color: '#8BA3C4' }}>{l.completionPct}% ({l.completed}/{l.total})</span>
                  </div>
                  <div>
                ...
                <div>
                  ...
                  {savingTier === l.id && (
                    <span className="text-xs ml-2" style={{ color: '#8BA3C4' }}>Saving...</span>
                  )}
                </div>
              </div>
            )}
