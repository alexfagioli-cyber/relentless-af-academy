...
const navItems = [
  {
    ...
    href: '/',
    icon: (active: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={active ? '#DC2626' : '#9CA3AF'} className="w-5 h-5">
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 pb-safe" style={{ backgroundColor: '#1E293B', borderTop: '1px solid #334155' }}>
