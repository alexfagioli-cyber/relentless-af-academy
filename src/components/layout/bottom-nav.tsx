...
const navItems = [
  {
    ...
    href: '/',
    icon: (active: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={active ? '#DC2626' : '#8BA3C4'} className="w-5 h-5">
      ...
      <div className="flex items-center justify-around h-16 max-w-lg mx-auto">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              {item.icon(isActive)}
              <span className="text-xs" style={{ color: isActive ? '#DC2626' : '#8BA3C4' }}>
                {item.label}
              </span>
            </Link>
          )
